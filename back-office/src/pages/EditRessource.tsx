...
const EditRessource = () => {
  ...
  useEffect(() => {
    // Remplacer par une requête API pour récupérer la ressource existante avec l'ID - DEBUT
    const fetchRessource = async () => {
      setRessource({
        title: "Titre existant",
        author: "Auteur existant",
  ...
  // Remplacer par une requête API pour récupérer la ressource existante avec l'ID - FIN
